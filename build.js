...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mutations = {
		...
		'DELETE_ITEM': function DELETE_ITEM(state) {
			state.items.pop();
		}
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Side = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\Side.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 		<li @click='addItem({content:Math.random()})' style='cursor:pointer;'>增加</li>
...
/***/ (function(module, exports) {
	...
	var addItem = exports.addItem = function addItem(store, item) {
		var dispatch = store.dispatch;
		dispatch('ADD_ITEM', item);
	};

	var deleteItem = exports.deleteItem = function deleteItem(store) {
		var dispatch = store.dispatch;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-08fce740/Content.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
